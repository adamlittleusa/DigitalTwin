...
His most recent role was Principal Product Manager for AI-Driven Security Response at Corelight, where he owned product strategy for Model Context Protocol (MCP) integrations, SIEM content, and agentic investigation workflows. Before that he spent more than two and a half years at Accenture building and leading a cybersecurity consulting and advisory practice, and four years at Recorded Future moving from customer success into product architecture. Before all of that he spent two decades in Army intelligence operations, specializing in human intelligence collection, and made the jump into cybersecurity in 2017.
